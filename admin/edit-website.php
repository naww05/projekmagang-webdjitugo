            ...
            <div class="card shadow mb-4">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-content flex-row">
                        ...
                        <input type="hidden" name="web" value = "<?= $p->id ?>">
                    </div>
                    <div class="card-body">
                    ...
                    <button type="submit" class="btn btn-secondary me-2"><a class="text-light link-underline link-underline-opacity-0" href="website.php">Cancel</button></a>
                        <button type="submit" class="btn btn-primary" name="update-web">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4 me-3">
                ...
                <div class="card-body py-3 d-flex flex-row align-items-center justify-content-between">
                    <a href="view-website.php?id=<?= $p->id?>" class="btn btn-info btn-sm">View</a>
