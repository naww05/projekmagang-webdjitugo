        ...
        <div class="col-lg-9 ms-3">
            <div class="card shadow mb-4">
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary fs-4">View Entry Client Social Media</h6>
                </div>
                ...
                <div class="card-content flex-row">
                    ...
                    <a href="../uploads/social/<?= $p->logo ?>" target="_blank"><h6><?php echo $p->logo ?></h6></a>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4 me-3">
                ...
                <div class="card-body py-3 d-flex flex-row align-items-center justify-content-between">
                    <a href="edit-social.php?id=<?= $p->id?>" class="btn btn-primary btn-sm">Edit</a>
...
<div class="modal fade" id="delete<?=$idsocial;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <!-- modal body -->
            ...
            <div class="modal-body">
                ...
                <br>
                <br>
                <button type="submit" class="btn btn-danger" name="delete-social">Hapus</button>
            </div>
            </form>
        </div>
    </div>
