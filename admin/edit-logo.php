            ...
            <div class="card shadow mb-4">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body d-flex justify-content-end">
                        <button type="submit" class="btn btn-secondary me-2"><a class="text-light link-underline link-underline-opacity-0" href="logo.php">Cancel</button></a>
                        <button type="submit" class="btn btn-primary" name="update-logo">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4 me-3">
                ...
                <div class="card-body py-3 d-flex flex-row align-items-center justify-content-between">
                    <a href="view-logo.php?id=<?= $p->id?>" class="btn btn-info btn-sm">View</a>
