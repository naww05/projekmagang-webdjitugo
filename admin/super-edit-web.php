        ...
        <div class="col-lg-9 ms-3">
            <div class="card shadow mb-4">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <button type="submit" class="btn btn-secondary me-2"><a class="text-light link-underline link-underline-opacity-0" href="admin-web.php">Cancel</button></a>
                        <button type="submit" class="btn btn-primary" name="super-update-web">Save</button>
                    </div>
                </form>
            </div>
        </div>
        ...
        <div class="col-lg">
            ...
            <div class="card shadow mb-4 me-3">
                ...
                <div class="card-body py-3 d-flex flex-row align-items-center justify-content-between">
                    <a href="admin-view-web.php?id=<?= $p->id?>" class="btn btn-info btn-sm">View</a>
