...
<html lang="en">
  <head>
    ...
    <title>Form Client Website</title>
                ...
                <div class="login-right w-50 ms-5">
                    <form method="POST" enctype="multipart/form-data">
                        <div class="form-header mb-3">
                            ...
                            ?>
                            <h2 class="fw-medium">Form Client Website</h2>
                        </div>
                        <div class="row">
                            <div class="mb-3 col">
                        ...
                        <div class="row">
                            <!-- <div class="mb-3 col-md-6">
                                <label for="formFileMultiple" name="product" class="form-label">Photo of Products</label>
                        ...
                        <button type="submit" name="save-web" class="btn btn-warning submit-btn">Submit</button>
                    </form>
                </div>
            </section>
        </div>
