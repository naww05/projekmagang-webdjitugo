<?php
    ...
    // session_start();
    if($_SESSION['ulevel'] !== 'admin_social') {
...
<head>
    ...
    <title>Admin Social Media Djitugo Internasional</title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-black sidebar sidebar-white accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="admin-social.php">
